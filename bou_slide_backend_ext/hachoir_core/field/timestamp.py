from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import (humanDatetime, humanDuration,
    timestampUNIX, timestampMac32, timestampUUID60,
    timestampWin64, durationWin64)
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import Bits, FieldSet
