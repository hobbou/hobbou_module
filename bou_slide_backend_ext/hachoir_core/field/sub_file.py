from openerp.addons.bou_slide_backend_ext.hachoir_core.field import Bytes
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import makePrintable, humanFilesize
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import InputIOStream
