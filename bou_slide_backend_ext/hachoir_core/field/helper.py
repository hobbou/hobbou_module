from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldError,
    RawBits, RawBytes,
    PaddingBits, PaddingBytes,
    NullBits, NullBytes,
    GenericString, GenericInteger)
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import FileOutputStream
