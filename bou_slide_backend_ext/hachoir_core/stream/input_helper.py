from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import getTerminalCharset, guessBytesCharset, _
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import InputIOStream, InputSubStream, InputStreamError
