...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError,
    ...
    Bit, Bits, NullBits)
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import NETWORK_ENDIAN, LITTLE_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanDuration
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, hexadecimal
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import createDict
from openerp.addons.bou_slide_backend_ext.hachoir_parser.network.common import MAC48_Address, IPv4_Address, IPv6_Address
