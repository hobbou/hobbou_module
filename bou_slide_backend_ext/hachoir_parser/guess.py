...
import os
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import warning, info, HACHOIR_ERRORS
from parser import ValidateError
from parser_list import HachoirParserList
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import FileInputStream
