...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError,
    ...
    RawBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, filesizeHandler, hexadecimal
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.common.deflate import Deflate
