...
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import MIDDLE_ENDIAN, LITTLE_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import paddingSize, alignValue
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive.zlib import build_tree, HuffmanCode, extend_data
