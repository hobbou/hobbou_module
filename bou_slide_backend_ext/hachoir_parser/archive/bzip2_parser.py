...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (Field, FieldSet, GenericVector,
    ParserError, String,
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive.zlib import build_tree, HuffmanCode
