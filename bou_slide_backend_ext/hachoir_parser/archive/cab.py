...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, Enum,
    CString, String,
    UInt8, UInt16, UInt32, Bit, Bits, PaddingBits, NullBits,
    DateTimeMSDOS32, RawBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, hexadecimal, filesizeHandler
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import LITTLE_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import paddingSize
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import StringInputStream
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive.lzx import LZXStream, lzx_decompress
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive.zlib import DeflateBlock
