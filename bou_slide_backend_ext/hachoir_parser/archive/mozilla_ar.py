...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (RootSeekableFieldSet, FieldSet,
    String, CString, UInt32, RawBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import displayHandler, filesizeHandler
