...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.parser import Parser, HachoirParser
import sys
...
class HachoirParserList(ParserList):
    ...
    def _load(self):
        ...
        todo = []
        # module = __import__("openerp.addons.bou_slide_backend_ext.hachoir_parser.parser")
        module = __import__('openerp.addons.bou_slide_backend_ext.hachoir_parser', globals(), locals(), ['Parser', 'HachoirParser'], -1)
