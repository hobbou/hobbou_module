...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, SeekableFieldSet, ParserError,
    UInt8, UInt16, UInt32,
    Int8, Int16, Int32,
    Float32, Float64,
    Enum, String, Bytes, SubFile,
    NullBits, NullBytes, createPaddingField)
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import LITTLE_ENDIAN, BIG_ENDIAN, NETWORK_ENDIAN
