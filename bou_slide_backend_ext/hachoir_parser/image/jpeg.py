...
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import HachoirError
from openerp.addons.bou_slide_backend_ext.hachoir_parser import Parser
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError, FieldError,
    UInt8, UInt16, Enum, Field,
    Bit, Bits, NullBits, NullBytes, PaddingBits,
    String, RawBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.common import PaletteRGB
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import BIG_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, hexadecimal
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.exif import Exif
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.photoshop_metadata import PhotoshopMetadata
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive.zlib import build_tree
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import paddingSize, alignValue
