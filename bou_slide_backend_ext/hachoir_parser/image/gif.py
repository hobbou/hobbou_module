...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanDuration, paddingSize
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, displayHandler, hexadecimal
