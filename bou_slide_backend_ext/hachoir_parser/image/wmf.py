...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, StaticFieldSet, Enum,
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.common import RGBA
