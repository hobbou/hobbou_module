...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import Parser as GenericParser
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import HACHOIR_ERRORS, HachoirError, error
