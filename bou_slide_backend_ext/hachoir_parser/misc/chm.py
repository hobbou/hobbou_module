...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (Field, FieldSet, ParserError, RootSeekableFieldSet,
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.common.win32_lang_id import LANGUAGE_ID
