...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.misc.msoffice import PROPERTY_NAME, RootEntry, RawParser, CustomFragment
