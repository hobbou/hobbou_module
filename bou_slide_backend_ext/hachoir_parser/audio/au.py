...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import UInt32, Enum, String, RawBytes
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import createDict, humanFrequency
