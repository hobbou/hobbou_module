...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, Bits, ParserError,
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import createDict, humanDurationNanosec
