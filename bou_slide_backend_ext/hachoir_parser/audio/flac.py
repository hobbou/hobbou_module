...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import FieldSet, String, Bit, Bits, UInt16, UInt24, RawBytes, Enum, NullBytes
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import BIG_ENDIAN, LITTLE_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import createDict
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container.ogg import parseVorbisComment
