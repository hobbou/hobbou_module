...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet,
    ...
    RawBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_parser.audio.id3 import ID3v1, ID3v2
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import BIG_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanFrequency, humanBitSize
from openerp.addons.bou_slide_backend_ext.hachoir_core.bits import long2raw
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import HACHOIR_ERRORS
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import InputStreamError
