...
from openerp.addons.bou_slide_backend_ext.hachoir_parser import Parser
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError,
    Bit, Bits, UInt8, UInt16, Int32, UInt32, Int64, CString, Enum,
    Bytes, RawBytes, NullBits, String, SubFile)
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import LITTLE_ENDIAN, BIG_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import textHandler, filesizeHandler
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import paddingSize, humanFrequency
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.common import RGB
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.jpeg import JpegChunk, JpegFile
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import StringInputStream, ConcatStream
from openerp.addons.bou_slide_backend_ext.hachoir_parser.common.deflate import Deflate, has_deflate
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container.action_script import parseActionScript, parseABC
import math
