...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError,
    ...
    SubFile)
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import alignValue, humanDuration
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import LITTLE_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.text_handler import filesizeHandler, textHandler
from openerp.addons.bou_slide_backend_ext.hachoir_parser.video.fourcc import audio_codec_name, video_fourcc_name
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.ico import IcoFile
