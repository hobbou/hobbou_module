...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (Field, FieldSet, createOrphanField,
    NullBits, Bit, Bits, Enum, Fragment, MissingField, ParserError,
    UInt8, UInt16, UInt24, UInt32, UInt64,
    RawBytes, String, PascalString32, NullBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_core.stream import FragmentedStream, InputStreamError
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import LITTLE_ENDIAN, BIG_ENDIAN
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanDurationNanosec
