...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, ParserError, Enum,
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import createDict, paddingSize, alignValue, makePrintable
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import HACHOIR_ERRORS
from openerp.addons.bou_slide_backend_ext.hachoir_parser.common.win32 import BitmapInfoHeader
