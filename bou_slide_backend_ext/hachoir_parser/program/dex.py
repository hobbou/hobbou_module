...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (SeekableFieldSet, RootSeekableFieldSet, FieldSet, ParserError,
...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.program.java import eat_descriptor
