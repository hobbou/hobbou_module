...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, UInt8,
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import ngettext
if DISASSEMBLE:
    from dis import dis
