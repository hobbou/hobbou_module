...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import String, UInt32, UInt8, Enum, FieldSet, RawBytes, GenericVector, Bit, Bits
from openerp.addons.bou_slide_backend_ext.hachoir_parser.parser import Parser
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.common import PaletteRGBA
