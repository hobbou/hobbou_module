...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import StaticFieldSet
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import Bit, NullBits
