from openerp.addons.bou_slide_backend_ext.hachoir_core.compatibility import sorted
from openerp.addons.bou_slide_backend_ext.hachoir_parser import Parser
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (FieldSet, StaticFieldSet,
    RawBytes, PaddingBytes, createPaddingField, Link, Fragment,
    Bit, Bits, UInt8, UInt16, UInt32,
    String, Bytes, NullBytes)
from openerp.addons.bou_slide_backend_ext.hachoir_core.field.integer import GenericInteger
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import error
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanFilesize, makePrintable
import datetime
import re
