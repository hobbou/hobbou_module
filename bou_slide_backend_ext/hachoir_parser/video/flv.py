...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.audio.mpeg_audio import Frame
from openerp.addons.bou_slide_backend_ext.hachoir_parser.video.amf import AMFObject
