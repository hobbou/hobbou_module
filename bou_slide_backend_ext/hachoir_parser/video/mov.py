...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import (ParserError, FieldSet, MissingField,
    Enum,
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import MAC_TIMESTAMP_T0, timedelta
...
from openerp.addons.bou_slide_backend_ext.hachoir_core.field.timestamp import timestampFactory
