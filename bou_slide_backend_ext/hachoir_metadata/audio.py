...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.audio import AuFile, MpegAudioFile, RealAudioFile, AiffFile, FlacParser
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container import OggFile, RealMediaFile
from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import _
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import makePrintable, timedelta2seconds, humanBitRate
from datetime import timedelta
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata_item import QUALITY_FAST, QUALITY_NORMAL, QUALITY_BEST
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.safe import fault_tolerant, getValue
