...
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import (
    humanDuration, humanBitRate,
    humanFrequency, humanBitSize, humanFilesize,
    humanDatetime)
from openerp.addons.bou_slide_backend_ext.hachoir_core.language import Language
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.filter import Filter, NumberFilter, DATETIME_FILTER
from datetime import date, datetime, timedelta
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.formatter import (
    humanAudioChannel, humanFrameRate, humanComprRate, humanAltitude,
    humanPixelSize, humanDPI)
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.setter import (
    setDatetime, setTrackNumber, setTrackTotal, setLanguage)
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata_item import Data
