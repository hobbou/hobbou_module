...
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata import Metadata, MultipleMetadata, registerExtractor
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.safe import fault_tolerant, getValue
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container.riff import RiffFile
from openerp.addons.bou_slide_backend_ext.hachoir_parser.video.fourcc import UNCOMPRESSED_AUDIO
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanFilesize, makeUnicode, timedelta2seconds
from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import _
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.audio import computeComprRate as computeAudioComprRate
