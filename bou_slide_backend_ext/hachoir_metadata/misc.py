from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata import RootMetadata, registerExtractor
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.safe import fault_tolerant
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container import SwfFile
from openerp.addons.bou_slide_backend_ext.hachoir_parser.misc import TorrentFile, TrueTypeFontFile, OLE2_File, PcfFile
from openerp.addons.bou_slide_backend_ext.hachoir_core.field import isString
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import warning
from openerp.addons.bou_slide_backend_ext.hachoir_parser import guessParser
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.setter import normalizeString
