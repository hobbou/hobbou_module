...
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image import (
    BmpFile, IcoFile, PcxFile, GifFile, PngFile, TiffFile,
    XcfFile, TargaFile, WMF_File, PsdFile)
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.png import getBitsPerPixel as pngBitsPerPixel
from openerp.addons.bou_slide_backend_ext.hachoir_parser.image.xcf import XcfProperty
