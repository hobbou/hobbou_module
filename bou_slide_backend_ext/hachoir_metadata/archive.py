from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata_item import QUALITY_BEST, QUALITY_FASTEST
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.safe import fault_tolerant, getValue
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata import (
    RootMetadata, Metadata, MultipleMetadata, registerExtractor)
from openerp.addons.bou_slide_backend_ext.hachoir_parser.archive import (Bzip2Parser, CabFile, GzipParser,
    TarFile, ZipFile, MarFile)
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import humanUnixAttributes
