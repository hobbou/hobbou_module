# -*- coding: utf-8 -*-
from openerp.addons.bou_slide_backend_ext.hachoir_core.compatibility import any, sorted
from openerp.addons.bou_slide_backend_ext.hachoir_core.endian import endian_name
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import makePrintable, makeUnicode
from openerp.addons.bou_slide_backend_ext.hachoir_core.dict import Dict
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import error, HACHOIR_ERRORS
from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import _
from openerp.addons.bou_slide_backend_ext.hachoir_core.log import Logger
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata_item import (
    MIN_PRIORITY, MAX_PRIORITY, QUALITY_NORMAL)
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.register import registerAllItems
