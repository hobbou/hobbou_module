from openerp.addons.bou_slide_backend_ext.hachoir_core.field import MissingField
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata import (registerExtractor,
    Metadata, RootMetadata, MultipleMetadata)
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.metadata_item import QUALITY_GOOD
from openerp.addons.bou_slide_backend_ext.hachoir_metadata.safe import fault_tolerant
from openerp.addons.bou_slide_backend_ext.hachoir_parser.video import MovFile, AsfFile, FlvFile
from openerp.addons.bou_slide_backend_ext.hachoir_parser.video.asf import Descriptor as ASF_Descriptor
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container import MkvFile
from openerp.addons.bou_slide_backend_ext.hachoir_parser.container.mkv import dateToDatetime
from openerp.addons.bou_slide_backend_ext.hachoir_core.i18n import _
from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import makeUnicode, makePrintable, timedelta2seconds
