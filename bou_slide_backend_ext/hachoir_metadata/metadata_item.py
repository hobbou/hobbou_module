from openerp.addons.bou_slide_backend_ext.hachoir_core.tools import makeUnicode, normalizeNewline
from openerp.addons.bou_slide_backend_ext.hachoir_core.error import HACHOIR_ERRORS
from openerp.addons.bou_slide_backend_ext.hachoir_metadata import config
